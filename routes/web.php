...
Route::group(['middleware' => 'auth'],function(){
	...
	Route::post('/stu_attend_conf/upload',['uses'=>'stu\StuAttendConfController@upload']);
	Route::get('/stu_attend_conf/example',['uses'=>'stu\StuAttendConfController@example']);
	...
	Route::post('/stu_to_partner_school/upload',['uses'=>'stu\StuToPartnerSchoolController@upload']);
	Route::get('/stu_to_partner_school/example',['uses'=>'stu\StuToPartnerSchoolController@example']);
	...
	Route::post('/stu_foreign_research/upload',['uses'=>'stu\StuForeignResearchController@upload']);
	Route::get('/stu_foreign_research/example',['uses'=>'stu\StuForeignResearchController@example']);
	...
	Route::post('/stu_from_partner_school/upload',['uses'=>'stu\StuFromPartnerSchoolController@upload']);
	Route::get('/stu_from_partner_school/example',['uses'=>'stu\StuFromPartnerSchoolController@example']);
	...
	Route::post('/short_term_foreign_stu/upload',['uses'=>'stu\ShortTermForeignStuController@upload']);
	Route::get('/short_term_foreign_stu/example',['uses'=>'stu\ShortTermForeignStuController@example']);
	...
	Route::post('/foreign_stu/upload',['uses'=>'stu\ForeignStuController@upload']);
	Route::get('/foreign_stu/example',['uses'=>'stu\ForeignStuController@example']);
	...
	Route::post('/transnational_degree/upload',['uses'=>'other\TransnationalDegreeController@upload']);
	Route::get('/transnational_degree/example',['uses'=>'other\TransnationalDegreeController@example']);
	...
	Route::post('/partner_school/upload',['uses'=>'other\PartnerSchoolController@upload']);
	Route::get('/partner_school/example',['uses'=>'other\PartnerSchoolController@example']);
	...
	Route::post('/cooperation_proj/upload',['uses'=>'other\CooperationProjController@upload']);
	Route::get('/cooperation_proj/example',['uses'=>'other\CooperationProjController@example']);
	...
	Route::post('/internationalize_activity/upload',['uses'=>'other\InternationalizeActivityController@upload']);
	Route::get('/internationalize_activity/example',['uses'=>'other\InternationalizeActivityController@example']);
