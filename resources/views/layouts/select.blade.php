	...
	<!-- <div class="form-group">
		<label for="dept">系所部門</label>
		<select name="dept" id="1" class="form-control">
			<option value="0">文學院</option>
			<option value="10">中文系/中文所</option>
			<option value="15">外文系/外文所/英語教學研究所</option>
			<option value="20">歷史系/歷史所</option>
		...
		<select name="dept" id="2" class="hidden form-control">
		...
		<select name="dept" id="3" class="hidden form-control">
		...
		<select name="dept" id="4" class="hidden form-control">
		...
		<select name="dept" id="5" class="hidden form-control">
		...
		<select name="dept" id="6" class="hidden form-control">
			<option value="0">法學院</option>
			<option value="10">法律系/法律所</option>
			<option value="20">財經法律學系</option>
		</select>

		<select name="dept" id="7" class="hidden form-control">
		...
		<select name="dept" id="8" class="hidden form-control">
			<option value="0">校長室</option>
		</select>

		<select name="dept" id="9" class="hidden form-control">
			<option value="0">副校長室</option>
		</select>

		<select name="dept" id="10" class="hidden form-control">
			<option value="0">秘書室</option>
		</select>

		<select name="dept" id="11" class="hidden form-control">
			<option value="0">教務處</option>
			<option value="1">教務處教學組</option>
			<option value="2">教務處招生組</option>
		</select>

		<select name="dept" id="12" class="hidden form-control">
			<option value="0">學務處</option>
		</select>

		<select name="dept" id="13" class="hidden form-control">
			<option value="0">總務處</option>
		</select>

		<select name="dept" id="14" class="hidden form-control">
		...
		<select name="dept" id="15" class="hidden form-control">
			<option value="0">圖書館</option>
		</select>

		<select name="dept" id="16" class="hidden form-control">
			<option value="0">清江學習中心</option>
		</select>

		<select name="dept" id="17" class="hidden form-control">
			<option value="0">電算中心</option>
		</select>

		<select name="dept" id="18" class="hidden form-control">
			<option value="0">體育中心</option>
		</select>

		<select name="dept" id="19" class="hidden form-control">
			<option value="0">輔導中心</option>
		</select>

		<select name="dept" id="20" class="hidden form-control">
			<option value="0">環安中心</option>
		</select>

		<select name="dept" id="21" class="hidden form-control">
			<option value="0">人事室</option>
		</select>

		<select name="dept" id="22" class="hidden form-control">
			<option value="0">會計室</option>
		</select>

		<select name="dept" id="23" class="hidden form-control">
			<option value="0">國際處</option>
		</select>

		<select name="dept" id="24" class="hidden form-control">
			<option value="0">通識教育中心</option>
		</select>

		<select name="dept" id="25" class="hidden form-control">
