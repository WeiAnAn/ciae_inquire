...
<div class="row">
	...
	<div class="col-md-6">
		<div class="list-group">
			...
			<a href="{{URL('/stu_to_partner_school')}}" class="list-group-item">出國赴姊妹校參加交換計畫</a>
			<a href="{{URL('/stu_foreign_research')}}" class="list-group-item">其他出國研修情形</a>
			<a href="{{URL('/stu_from_partner_school')}}" class="list-group-item">姊妹校學生至本校參加交換計畫</a>
			<a href="{{URL('/short_term_foreign_stu')}}" class="list-group-item">外籍學生至本校短期交流訪問</a>
