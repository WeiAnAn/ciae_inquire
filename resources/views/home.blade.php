...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><b>國際化調查系統</b></h1>
	</div>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
	<div class="list-group">
		...
		<a href="#" class="list-group-item">外籍學者蒞校訪問</a>
	</div>
</div>
<div class="col-md-6">
	<div class="list-group">
		...
		<a href="#" class="list-group-item">姊妹校學生至本校參加交換計畫</a>
		<a href="#" class="list-group-item">外籍學生至本校短期交流訪問</a>
		<a href="#" class="list-group-item">修讀正式學位之外國學生</a>
	</div>
</div>
<div class="col-md-6">
	<div class="list-group">
		...
		<a href="#" class="list-group-item">國際化活動</a>
	</div>
</div>
@endsection