            	...
            	<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>	
								<tr>
									<td id="short_term_foreign_stu.college" onclick="sort(id)">單位</td>
									<td id="short_term_foreign_stu.dept" onclick="sort(id)">系所部門</td>
					...
					<div class="tab-pane fade in col-md-12" id="upload" style="margin-top: 10px;">
						...
						{{ csrf_field() }}
                        	...
                        	@if(count($errors->upload)>0)
                        		...
                        		@endif
                        	@endif
							<input type="file" class="" name="file" style="margin: 2px">
