            	...
            	<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>	
								<tr>
									<td id="stu_foreign_research.college" onclick="sort(id)">單位</td>
									<td id="stu_foreign_research.dept" onclick="sort(id)">系所部門</td>
					...
					<div class="tab-pane fade in col-md-12" id="upload" style="margin-top: 10px;">
						<form action="{{url('stu_foreign_research/upload')}}">
