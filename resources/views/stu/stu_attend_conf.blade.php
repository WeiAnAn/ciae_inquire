            	...
            	<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>	
								<tr>
									<td id="stu_attend_conf.college" class="text-nowrap" 
										onclick="sort(id)">所屬單位</td>
									<td id="stu_attend_conf.dept" class="text-nowrap" 
					...
					<div class="tab-pane fade in col-md-12" id="upload" style="margin-top: 10px;">
						<form action="{{url('stu_attend_conf/upload')}}" method="post" enctype="multipart/form-data">
                        	{{ csrf_field() }}
							...
							<a class="btn btn-success" href="{{url('stu_attend_conf/example')}}">範例檔案</a>
