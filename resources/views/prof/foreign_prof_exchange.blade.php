            	...
            	<div class="tab-content">
					...
					@endif
			        	...
			        	<table width="100%" class="table table-striped table-bordered table-hover">
				        	<thead>
				        		<tr>
				        			<td id="foreign_prof_exchange.college" class="text-nowrap"
				        				onclick="sort(id)">邀請單位
										<i class="fa fa-sort" aria-hidden="true"></i>
				        			</td>
									<td id="foreign_prof_exchange.dept" class="text-nowrap"
				...
				@endif
					<form action="{{url('foreign_prof_exchange')}}" method="post">
						...
						<div class="form-group col-md-6" style="padding-left:0 ;	padding-right: 0">
								...
								<input type="view" name="startDate" class="form-control" value="{{old('startDate')}}" id="insert_startDate">
						</div>
						<div class="form-group col-md-6" style="padding-left:0 ;	padding-right: 0">
								<label for="endDate">結束時間</label>
								<input type="view" name="endDate" class="form-control" value="{{old('endDate')}}" id="insert_endDate">
						</div>
				...
				<div class="tab-pane fade in col-md-12" id="search" style="margin-top: 10px;">
			        ...
			        <form action="{{url('foreign_prof_exchange/search')}}">
						...
						<div class="form-group col-md-6" style="padding-left:0 ;padding-right: 0">
							...
							<input type="date" name="startDate" class="form-control" id="search_startDate">
						</div>
						<div class="form-group col-md-6" style="padding-left:0 ;padding-right: 0">
							<label for="endDate">到</label>
							<input type="date" name="endDate" class="form-control" id="search_endDate">
						</div>
						<div class="form-group">
							<label for="comments">備註</label>
